#' Plot Method for the "Trialdesign" Object
#'
#' Plot method for the class "trialdesign".
#'
#' @param object An object of class "trialdesign".
#' @param ... Other parameters to be passed through to plotting functions.
#'
#' @return A scatterplot of the relationship between the sample size and the squared drift parameter.
#' @export
#'
#' @examples
...
#' plot(newdesign)
#'
plot.trialdesign <- function(object,...){

  plot(object$sizevec,object$sqdrift,xlab = "Sample Size",ylab="Squared Drift Parameter",...)
}
